...
bool editDefaults(SeizaDefaults& defaults) {
    @autoreleasepool {
        ...
        alert.messageText = @"Seiza - Default settings";
        alert.informativeText = @"Seiza Astronomy Formats 0.3.0 - shared by FITS and XISF.\n\n"
            ...
            @"Defaults apply to new files. Existing documents keep remembered choices.";
        ...
        [write selectItemAtIndex:defaults.writeDepth == 16 ? 1 : 0];
        ...
        defaults.writeDepth = write.indexOfSelectedItem == 1 ? 16 : 32;
